...
public class Excontroller {
	...
	@RequestMapping("/ex5") // 커맨드 객체 없이 파라미터 localhost:8081/ex4?username=xxx&age=00
	...
	public String ex4(@PathVariable String username, @PathVariable(name = "userage") Integer age) {
		System.out.println("이름 = " + username + ", 나이 = " + age);
		return "index";
	}
